...
for i in range(int(iterations)):
    ...
    Kill_whatsapp()
print("launch_pass_cnt is:",launch_pass_cnt)
print("launch_fail_cnt is:",launch_fail_cnt)
print("message_pass_cnt is:",msg_pass_cnt)
print("message_fail_cnt is:",msg_fail_cnt)
print("voice_pass_cnt is:",voice_pass_cnt)
print("voice_fail_cnt is:",voice_fail_cnt)
print("video_pass_cnt is:",video_pass_cnt)
print("video_fail_cnt is:",video_fail_cnt)
